...
describe('ProductEditComponent', () => {
  ...
  //check for the presence of product category in edit form
  ...
  //check for the input type of product id in edit form
  ...
  //check for the input type of product title in edit form
  ...
  //check for the input type of product description in edit form
  ...
  //check for the input type of product price in edit form
  ...
  //check for the input type of product image in edit form
  ...
  //check for the input type of product category in edit form
  ...
  //check for the input type of product rating in edit form
  ...
  //check for the button when data is valid
